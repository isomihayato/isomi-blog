...
import { deleteStorage, getStorage, setStorage } from '@/Components/common/functions';
import firebase from 'firebase/app';
import 'firebase/auth';
// import { postLogin } from 'functions/axiosSession';
    ...
    try {
      ...
      if (error.code === "auth/account-exists-with-different-credential") {
        ...
        try {
          ...
          postMember({ fb_uid: createResult.user.uid }, (res: any) => {
            console.log(res.data);
          }, (err: any) => {
            console.log(err);
          });
